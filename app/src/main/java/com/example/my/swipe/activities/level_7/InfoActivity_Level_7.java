...
import com.example.my.swipe.activities.level_6.Level_6_Activity;
import com.example.my.swipe.utils.Preferences;

public class InfoActivity_Level_7 extends InfoBaseActivity {

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_info_level_7);

    TextView starGameTextView = (TextView) findViewById(R.id.start_game);
    blinkText(starGameTextView);

    levelCounterTextView = (TextView) findViewById(R.id.info_activity_level7_level_counter);
    ...
    levelIndex = bundle.getInt(Preferences.LEVEL, 7);
  ...
  public void handleClick(View view) {
    ...
    Intent intent = new Intent(this, Level_7a_Activity.class);
